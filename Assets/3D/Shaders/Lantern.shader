...
Shader "Shader Forge/Lantern" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_4433; uniform float4 _node_4433_ST;
            uniform sampler2D _node_722; uniform float4 _node_722_ST;
            uniform sampler2D _node_2735; uniform float4 _node_2735_ST;
            struct VertexInput {
...
/////// Diffuse:
                ...
                float4 _node_4433_var = tex2D(_node_4433,TRANSFORM_TEX(i.uv0, _node_4433));
                float3 diffuseColor = _node_4433_var.rgb;
