...
////// Lighting:
////// Emissive:
                float3 node_4850 = (i.vertexColor.rgb*lerp((_Ambient*UNITY_LIGHTMODEL_AMBIENT.rgb),_LightColor0.rgb,saturate(dot(i.normalDir,lightDirection))));
